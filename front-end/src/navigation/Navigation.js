  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="TelaLogin">
        ...
        <Stack.Screen name="TelaPedido" component={TelaPedido} options={{ headerShown: false }}/>

        <Stack.Screen name="TelaAtribuicao" component={TelaAtribuicao} options={{ headerShown: false }}/>
